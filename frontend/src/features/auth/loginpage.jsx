        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-12 py-3 text-lg border-slate-300 focus:border-purple-500 focus:ring-purple-500/20 dark:bg-background dark:text-foreground dark:border-white/10 dark:placeholder:text-slate-500 dark:focus:border-purple-500 dark:focus:ring-purple-500/30"
            />
          </div>
        </div>
